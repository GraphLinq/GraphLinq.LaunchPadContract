...
export interface UpgradeabilityTestInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "testCreateFundraiser",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testUpgradeability",
    values?: undefined
  ): string;
...
export interface UpgradeabilityTest extends BaseContract {
  ...
  getFunction(
    nameOrSignature: "testCreateFundraiser"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "testUpgradeability"
  ): TypedContractMethod<[], [void], "nonpayable">;
