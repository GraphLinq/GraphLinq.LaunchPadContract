...
export declare namespace Fundraiser {
  ...
  export type FundraiserParamsStructOutput = [
    saleToken: string,
    raiseToken: string,
    projectName: string,
    description: string,
...
export interface FundraiserInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "finalizedTimestamp",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getRequiredAmountsForLiquidity",
    values: [BigNumberish]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "vestingStartDelta",
    values?: undefined
  ): string;
...
export namespace LiquidityMintingFailedEvent {
  export type InputTuple = [];
  export type OutputTuple = [];
  export interface OutputObject {}
  export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
...
export namespace SwapPairInitializedEvent {
...
export interface Fundraiser extends BaseContract {
  ...
  getRequiredAmountsForLiquidity: TypedContractMethod<
    ...
    [[bigint, bigint] & { requiredSaleTokens: bigint }],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "finalizedTimestamp"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "getRequiredAmountsForLiquidity"
  ): TypedContractMethod<
    [raiseTokenAmount: BigNumberish],
    [[bigint, bigint] & { requiredSaleTokens: bigint }],
    "view"
  ...
  getFunction(
    nameOrSignature: "vestingStartDelta"
  ): TypedContractMethod<[], [bigint], "view">;
  ...
  >;
  getEvent(
    key: "SwapPairInitialized"
  ): TypedContractEvent<
    SwapPairInitializedEvent.InputTuple,
    SwapPairInitializedEvent.OutputTuple,
    SwapPairInitializedEvent.OutputObject
  >;
  ...
  filters: {
    ...
    "LiquidityMintingFailed()": TypedContractEvent<
      LiquidityMintingFailedEvent.InputTuple,
      LiquidityMintingFailedEvent.OutputTuple,
      LiquidityMintingFailedEvent.OutputObject
    >;
    ...
    "SwapPairInitialized(uint256,uint256)": TypedContractEvent<
      SwapPairInitializedEvent.InputTuple,
      SwapPairInitializedEvent.OutputTuple,
      SwapPairInitializedEvent.OutputObject
    >;
    SwapPairInitialized: TypedContractEvent<
      SwapPairInitializedEvent.InputTuple,
      SwapPairInitializedEvent.OutputTuple,
      SwapPairInitializedEvent.OutputObject
    >;
