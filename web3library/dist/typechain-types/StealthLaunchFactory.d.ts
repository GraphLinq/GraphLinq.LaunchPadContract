...
export interface StealthLaunchFactoryInterface extends Interface {
...
export interface StealthLaunchFactory extends BaseContract {
    connect(runner?: ContractRunner | null): StealthLaunchFactory;
    waitForDeployment(): Promise<this>;
    interface: StealthLaunchFactoryInterface;
