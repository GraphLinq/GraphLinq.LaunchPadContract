...
export interface StealthLaunchCampaignTestInterface extends Interface {
...
export interface StealthLaunchCampaignTest extends BaseContract {
    connect(runner?: ContractRunner | null): StealthLaunchCampaignTest;
    waitForDeployment(): Promise<this>;
    interface: StealthLaunchCampaignTestInterface;
