...
export interface UpgradeabilityTestInterface extends Interface {
    getFunction(nameOrSignature: "IS_TEST" | "excludeArtifacts" | "excludeContracts" | "excludeSenders" | "failed" | "setUp" | "targetArtifactSelectors" | "targetArtifacts" | "targetContracts" | "targetInterfaces" | "targetSelectors" | "targetSenders" | "testCreateFundraiser" | "testUpgradeability"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "testCreateFundraiser", values?: undefined): string;
    encodeFunctionData(functionFragment: "testUpgradeability", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "testCreateFundraiser", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "testUpgradeability", data: BytesLike): Result;
}
...
export interface UpgradeabilityTest extends BaseContract {
    connect(runner?: ContractRunner | null): UpgradeabilityTest;
    waitForDeployment(): Promise<this>;
    interface: UpgradeabilityTestInterface;
    ...
    testCreateFundraiser: TypedContractMethod<[], [void], "nonpayable">;
    testUpgradeability: TypedContractMethod<[], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "testCreateFundraiser"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "testUpgradeability"): TypedContractMethod<[], [void], "nonpayable">;
