...
export interface FairLaunchCampaignInterface extends Interface {
    ...
    decodeFunctionResult(functionFragment: "MINIMUM_GOAL", data: BytesLike): Result;
...
export interface FairLaunchCampaign extends BaseContract {
    connect(runner?: ContractRunner | null): FairLaunchCampaign;
    waitForDeployment(): Promise<this>;
    interface: FairLaunchCampaignInterface;
    ...
    MINIMUM_GOAL: TypedContractMethod<[], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "END_TIME"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "MINIMUM_GOAL"): TypedContractMethod<[], [bigint], "view">;
